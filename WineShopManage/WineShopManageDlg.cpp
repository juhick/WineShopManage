...
// CWineShopManageDlg 对话框




CWineShopManageDlg::CWineShopManageDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CWineShopManageDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CWineShopManageDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CWineShopManageDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CWineShopManageDlg 消息处理程序

BOOL CWineShopManageDlg::OnInitDialog()
{
...
void CWineShopManageDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CWineShopManageDlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CWineShopManageDlg::OnQueryDragIcon()
{
...
void CWineShopManageDlg::OnBnClickedStaffmvbt()
{
	// TODO: 在此添加控件通知处理程序代码
	CStaffMvDlg dlg;
	dlg.DoModal();
